...
> **⚠️ ACTION REQUIRED:** Replace `[canister-id]` with your actual canister ID from the deployment output before proceeding.

**Example format:** `https://xxxxx-xxxxx-xxxxx-xxxxx-xxx.icp0.io/`
